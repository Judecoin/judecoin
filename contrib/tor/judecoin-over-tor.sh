...
tail -n 400 "$HOME/.bitjudecoin/bitjudecoin.log" | grep -Ev stacktrace|"Error: Couldn't connect to daemon:"|"src/daemon/main.cpp:.*Jude\ '" | tail -n 20
exit 1
fi
