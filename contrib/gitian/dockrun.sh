...
RUN	git clone https://github.com/jude-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/jude-project/jude
...
if [ ! -d sigs ]; then
	git clone https://github.com/jude-project/gitian.sigs.git sigs
	cd sigs
