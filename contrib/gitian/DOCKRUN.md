...
*Setup instructions for a Gitian build of Jude using Docker.*
...
You'll also need to clone the jude repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/jude-project/jude.git
cd jude/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/jude-project/gitian.sigs/) repo on your GitHub account.
