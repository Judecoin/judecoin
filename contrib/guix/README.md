# Bootstrappable Jude Builds

This directory contains the files necessary to perform bootstrappable Jude 
builds.
...
To build Jude reproducibly with all default options, invoke the
...
repository](https://github.com/jude-project/guix.sigs).
