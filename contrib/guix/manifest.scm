...
(define* (make-jude-cross-toolchain  target
                                       #:key
...
desirable for building Jude release binaries."
...
(packages->manifest
 (append
  (list ;; The Basics
        ...
        python-minimal ; required to build jude (cmake/CheckTrezor.cmake) and in android_ndk
