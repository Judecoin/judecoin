...
which tells `judecoind` that ".onion" p2p addresses can be forwarded to a socks
...
received at address "rveahdfho7wo4b2m.onion:28083" and forwarded to `judecoind`
localhost port 28083, and a default max I2P connections are being received at
address "cmeua5767mz2q5jsaelk2rxhf67agrwuetaso5dzbenyzwlbkg2q.b32.i2p:5000" and
forwarded to `judecoind` localhost port 30000.
...
```
HiddenServiceDir /var/lib/tor/data/judecoin
...
This will store key information in `/var/lib/tor/data/judecoin` and will forward
"Tor port" 28083 to port 28083 of ip 127.0.0.1. The file
`/usr/lib/tor/data/judecoin/hostname` will contain the ".onion" address for use
